...
getgenv().ToTarget = function(Pos)
	...
	local Magnitude = TweenInfo.new((game.Players.LocalPlayer.Character.Root.Position - Pos.Position).Magnitude /230, Enum.EasingStyle.Linear)
	...
	local tween, error = pcall(function()
		tween = Tween_Service:Create(game.Players.LocalPlayer.Character["Root"], Magnitude, { CFrame = Pos })
		tween:Play() 
	end)
